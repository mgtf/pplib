% $Id: classes.tex,v 1.5 2002/03/25 12:47:53 tieum Exp $
\textcolor{section}{\section{Description des classes}}
  ...
  \begin{vars_def}{pp}
    \var{header\_str}{Chaine de caractère ajoutée au tout debut des données renvoyé par le parseur}
    \var{footer\_str}{Chaine de caractère ajoutée à la fin des données renvoyé par le parseur}
    \var{no\_parse}{Demande au parseur de renvoyer les données tel quel, sans les parser.
    ...
    \var{compress\_data}{Flag qui permet de contrôler la compression en gzip/x-gzip du code HTML avant l'envoi au client.
